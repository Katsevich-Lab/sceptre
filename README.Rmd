...
-   Large-scale analysis at low or high MOI: If you are running a
    ...
    active development and is not yet stable; please open a Github issue
    or send an email if you are interested.

## Associated papers

The following series of papers explores the statistical and
computational challenges at play in single-cell CRISPR screen analysis,
introduces the `sceptre` methodology, and applies `sceptre` to make
