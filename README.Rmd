...
`sceptre` is maintained as an open-source research-software project. The current
[roadmap](ROADMAP.md) describes
the package's technical and sustainability priorities. Please read the
[contribution guide](CONTRIBUTING.md), [governance model](GOVERNANCE.md), and
[Code of Conduct](CODE_OF_CONDUCT.md) before contributing. The [support
guide](SUPPORT.md)
explains where to ask questions, report bugs, and request features.
