...
Single-cell CRISPR screens (e.g., Perturb-seq, TAP-seq) combine CRISPR genome engineering and single-cell sequencing to survey the effects of genetic perturbations on individual cells. Despite their promise, single-cell CRISPR screens present considerable statistical and computational challenges. `sceptre` is an R package for single-cell CRISPR screen data analysis, emphasizing statistical rigor, computational efficiency, and ease of use.

**Update October 2023**: We have released `sceptre` version 0.4.0, which is a substantial rework of the package. `sceptre` is now easier to use, faster, more memory efficient, and more fully featured than before. Also, we have written an [e-book](https://timothy-barry.github.io/sceptre-book/) to guide users through the entire process of analyzing their data using `sceptre`.
...
`sceptre` is compatible with a broad range of single-cell CRISPR screen experimental designs:
...
The fastest way to get started with `sceptre` is to work through the Get Started vignette (30 minutes): `vignette("sceptre")`. Users also can read the `sceptre` [manual](https://timothy-barry.github.io/sceptre-book/).
...
We ask that users submit bugs and feature requests as issues to the [Github repository](https://github.com/Katsevich-Lab/sceptre/issues).

## Funding

[Analytics at Wharton](https://analytics.wharton.upenn.edu/) and the [National Science Foundation](https://www.nsf.gov/) (DMS-2113072) support the development of this software.

<img src="man/figures/wharton_analytics.png" align="center" width="200"/>     <img src="man/figures/nsf.jpeg" align="center" width="109"/>
