...
Single-cell CRISPR screens (e.g., Perturb-seq, TAP-seq) pose enormous potential for advancing understanding of human disease biology. However, the analysis of these screens presents considerable statistical and computational challenges. `sceptre` is an R package for single-cell CRISPR screen data analysis, emphasizing statistical rigor, computational efficiency, and ease of use.
...
The fastest way to get started with `sceptre` is to work through the Get Started vignette (10 minutes): `vignette("sceptre")`.
