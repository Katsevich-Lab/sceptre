...
First, ensure that you have downloaded and installed the package.
...
This script contains a single function `param_funct`, which takes the name of a parameter as an argument and returns the value of that parameter. `param_funct` must support the following parameters:
