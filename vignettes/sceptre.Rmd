...
sceptre_object <- sceptre_object |> # |> is R's base pipe, similar to %>%
  ...
  run_calibration_check(parallel = TRUE, n_processors = 2) |>
...
sceptre_object <- sceptre_object |> # |> is R's base pipe, similar to %>%
  ...
  run_power_check(print_progress = FALSE, parallel = FALSE) |>
  run_discovery_analysis(print_progress = FALSE, parallel = FALSE)
```
