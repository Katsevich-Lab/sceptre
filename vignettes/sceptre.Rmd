...
Users instead can input data from the Parse Biosciences count matrix generation software or from standard R matrices. See `vignette("import-data")` for more details about data import.
