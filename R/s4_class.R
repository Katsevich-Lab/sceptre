# class union
#' @import Matrix
# setClassUnion("grna_matrix_class", c("matrix", "dgCMatrix", "dgRMatrix",
# "dgTMatrix", "lgCMatrix", "lgRMatrix", "lgTMatrix"))
# setClassUnion("response_matrix_class", c("matrix", "dgCMatrix", "dgRMatrix",
# "dgTMatrix"))
