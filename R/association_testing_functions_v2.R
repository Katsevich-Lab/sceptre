# helper function 1: compute D matrix
...
# helper function 2: get undercover idx vector
...
# helper function 3: get discovery idx vector
...
# workhorse function 1: discovery analysis complement set perm test
