...
#' Plot covariates
#'
#' `plot_covariates()` visualizes the distribution of the cell-specific covariates `response_n_nonzero` (the number of responses expressed in the cell), `response_n_umis`, and (if applicable) `response_p_mito`. To help guide the selection of QC thresholds, `plot_covariates()` plots candidate QC thresholds as vertical lines on the histograms.
#'
#' response_n_nonzero (i.e., the number of responses expressed in the cell), response_n_umis (i.e., the number of response UMIs sequenced in the cell), response_p_mito (i.e., the fraction of transcripts mapping to mitochondrial genes
#'
...
#' @param response_n_umis_range (optional; default \code{c(0.01, 0.99)}) a numeric vector of length 2 giving the lower and upper limits of the x-axis for the `response_n_nonzero` feature.
#' @param response_n_nonzero_range (optional; default \code{c(0.01, 0.99)}) a numeric vector of length 2 giving the lower and upper limits of the x-axis for the `response_n_nonzero_range` feature.
#' @param p_mito_threshold (optional; default \code{0.2}) a single numeric value in the interval [0,1] specifying the location at which to draw a candidate QC threshold on the `response_p_mito` plot
#'
#' @return TBD
#' @export
#' @examples
